...
import SaskatchewanFlag from '../../../../images/Flag_of_Saskatchewan.svg';
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center h-screen p-8">
      <img className="h-48" src={SaskatchewanFlag} alt="saskatchewan flag" />
      ...
      <div className="p-4 text-gray-300 flex flex-col">
        <div>Built by blorppppp & modified by Ketsu</div>
        <div>
